...
```bash
node -e "const {runDiagnostics}=require('./.lmas-core/core/synapse/diagnostics/synapse-diagnostics');console.log(runDiagnostics(process.cwd()))"
```
...
- **SYNAPSE diagnostics**: `.lmas-core/core/synapse/diagnostics/synapse-diagnostics.js`
