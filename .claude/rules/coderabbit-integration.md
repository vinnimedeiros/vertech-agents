...
wsl bash -c 'cd /mnt/c/.../lmas-core && ~/.local/bin/coderabbit --severity CRITICAL,HIGH --auto-fix'

# Manual review
wsl bash -c 'cd /mnt/c/.../lmas-core && ~/.local/bin/coderabbit -t uncommitted'
...
Full config in `.lmas-core/core-config.yaml` under `coderabbit_integration` section.
