---
paths:
  - .lmas-core/data/tool-registry.yaml
  - .mcp.json
---
...
configuration defined in `.lmas-core/data/tool-registry.yaml` for the tool that
...
`.lmas-core/utils/filters/` are available for batch post-processing of
