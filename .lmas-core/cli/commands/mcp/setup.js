 ...
 * MCP Setup Command
 *
 * Creates the global ~/.lmas/mcp/ directory structure.
 *
...
function createSetupCommand() {
  ...
  setup
    .description('Create global MCP configuration structure at ~/.lmas/')
...
async function executeSetup(options) {
  ...
  console.log('\nNext steps:');
  console.log('  1. Run "lmas mcp link" in your project to use global config');
  console.log('  2. Run "lmas mcp add <server>" to add more servers');
  console.log('  3. Run "lmas mcp status" to check configuration');
