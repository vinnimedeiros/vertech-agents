...
Data Storage:
  Metrics are stored in .lmas/data/quality-metrics.json
...
Examples:
  $ lmas metrics record --layer 1 --passed --duration 3200
  $ lmas metrics record --layer 2 --passed --findings 3 --coderabbit
  $ lmas metrics show
  $ lmas metrics show --layer 2
  $ lmas metrics show --format json
  $ lmas metrics seed --days 30
  $ lmas metrics cleanup
  $ lmas metrics cleanup --dry-run
`);
