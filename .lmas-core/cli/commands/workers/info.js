 ...
 *
 * Implements `lmas workers info <id>` CLI command.
...
function createInfoCommand() {
  ...
  info
    ...
    .addHelpText('after', `
Examples:
  $ lmas workers info json-csv-transformer
  $ lmas workers info architect-checklist --format=json
  $ lmas workers info create-story --format=yaml
  $ lmas workers info data-analyzer --verbose
