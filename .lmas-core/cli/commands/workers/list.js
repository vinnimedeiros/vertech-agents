 ...
 *
 * Implements `lmas workers list` CLI command.
...
Examples:
  $ lmas workers list
  $ lmas workers list --category=task
  $ lmas workers list --format=table
  $ lmas workers list --format=json --category=script
  $ lmas workers list --page=2 --limit=10
  $ lmas workers list --count
  $ lmas workers list --verbose
