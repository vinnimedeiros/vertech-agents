 ...
 *
 * Implements `lmas workers search <query>` CLI command.
...
Examples:
  ...
  $ lmas workers search "data transformation" --category=etl
  $ lmas workers search "validation" --tags=schema,json
  $ lmas workers search "api" --format=json --limit=5
  $ lmas workers search "transform" --semantic
  $ lmas workers search "convert" --keyword
`)
