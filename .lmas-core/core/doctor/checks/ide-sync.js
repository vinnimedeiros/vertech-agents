 ...
 * .lmas-core/development/agents/ (count and names).
 *
 * @module lmas-core/doctor/checks/ide-sync
 * @story INS-4.1
 */
...
async function run(context) {
  const agentsSourceDir = path.join(context.projectRoot, '.lmas-core', 'development', 'agents');
  const agentsIdeDir = path.join(context.projectRoot, '.claude', 'commands', 'LMAS', 'agents');
