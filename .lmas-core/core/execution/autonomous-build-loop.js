 ...
 * Inspired by Auto-Claude's Coder Agent but with LMAS extensibility.
 *
 * Features:
 * - AC1: Located in `.lmas-core/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Autonomous Build Loop')} - LMAS Coder Agent Loop (Story 8.1)
