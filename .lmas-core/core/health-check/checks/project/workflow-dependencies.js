 ...
 *
 * @module lmas-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ['lmas', 'workflows', 'dependencies'],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, '.lmas-core', 'development', 'workflows'),
      path.join(projectRoot, '.lmas-core', 'infrastructure', 'workflows'),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, '.lmas-core', 'development', 'tasks'),
      path.join(projectRoot, '.lmas-core', 'infrastructure', 'tasks'),
    ];
