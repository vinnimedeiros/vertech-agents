 ...
 *
 * Provides comprehensive health checking capabilities for LMAS projects.
 ...
 * The primary diagnostic interface is `lmas doctor` (bin/lmas.js → core/doctor/).
 * The agent-facing task `*health-check` now delegates to `lmas doctor --json`
