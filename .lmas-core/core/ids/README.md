...
The Entity Registry is the central data store for the Incremental Development System (IDS). It tracks all LMAS framework artifacts — tasks, templates, scripts, modules, agents, checklists, and data files — with metadata, relationships, adaptability scores, and checksums.

## Schema

The registry is stored at `.lmas-core/data/entity-registry.yaml` as a single YAML file.
...
categories:
  - id: "tasks"
    ...
    basePath: ".lmas-core/development/tasks"
```
...
```bash
node .lmas-core/development/scripts/populate-entity-registry.js
```
