 ...
 *
 * Facade class that integrates lmas-master with the IDS Entity Registry for
 ...
 *   const { RegistryUpdater } = require('.lmas-core/core/ids/registry-updater');
 *   const { FrameworkGovernor } = require('.lmas-core/core/ids/framework-governor');
 *
  ...
  async postRegister(filePath, metadata = {}) {
    ...
    return this._withTimeout(async () => {
      const task = {
        ...
        agent: metadata.agent || 'lmas-master',
