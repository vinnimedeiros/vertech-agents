...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.lmas-core/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.lmas-core/data/registry-backups/healing');
...
class RegistryHealer {
   ...
   * Integrates with LMAS NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          'Run \'lmas ids:health --fix\' after resolving',
        ];
    }
  }
