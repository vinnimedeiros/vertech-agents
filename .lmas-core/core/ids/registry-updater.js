...
const LOCK_FILE = path.resolve(REPO_ROOT, '.lmas-core/data/.entity-registry.lock');
const BACKUP_DIR = path.resolve(REPO_ROOT, '.lmas-core/data/registry-backups');
const AUDIT_LOG_PATH = path.resolve(REPO_ROOT, '.lmas-core/data/registry-update-log.jsonl');
