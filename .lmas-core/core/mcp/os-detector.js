...
/**
 * Get global LMAS directory path
 * @returns {string} Path to ~/.lmas/
 */
function getGlobalLmasDir() {
  return path.join(getHomeDir(), '.lmas');
}

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.lmas/mcp/
 */
function getGlobalMcpDir() {
  return path.join(getGlobalLmasDir(), 'mcp');
}

/**
 * Get global MCP config file path
 * @returns {string} Path to ~/.lmas/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.lmas/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.lmas/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.lmas/credentials/
 */
function getCredentialsDir() {
  return path.join(getGlobalLmasDir(), 'credentials');
}
