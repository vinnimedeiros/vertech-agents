 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .lmas-core/core/memory/
 * - AC2: Persists in .lmas/gotchas.json and .lmas/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.lmas/gotchas.json',
  gotchasMdPath: '.lmas/gotchas.md',
  errorTrackingPath: '.lmas/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'lmas-gotchas-memory-v1',
};
...
> Auto-generated by LMAS Gotchas Memory
> Last updated: ${now}
...
*Generated by LMAS Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - LMAS Memory Layer (Story 9.4)
