 ...
 *
 * Handles first execution behavior for existing projects without LMAS documentation.
...
class BrownfieldHandler extends EventEmitter {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.lmas-core/development/workflows/brownfield-discovery.yaml',
    );
      ...
      case PostDiscoveryChoice.RESOLVE_DEBTS:
        ...
        return {
          ...
          data: {
            ...
            taskPath: '.lmas-core/development/tasks/brownfield-create-epic.md',
            context,
          },
        };
