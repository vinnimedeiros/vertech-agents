 ...
 * - Session states older than 30 days (archived to .lmas/archive/sessions/)
...
const ARCHIVE_DIR = '.lmas/archive/sessions';
const SNAPSHOTS_DIR = '.lmas/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .lmas/archive/sessions/
   *
