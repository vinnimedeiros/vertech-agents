/**
 * Skill Dispatcher - Dispatches to LMAS Skills instead of generic Task calls
 *
 ...
 *
 * Responsibilities:
 * - Map agent IDs to LMAS Skill names
 ...
 * @property {string} skill - Full skill name (e.g., 'LMAS:agents:architect')
...
/**
 * Dispatches workflow phases to LMAS Skills
 */
/**
...
class SkillDispatcher {
  ...
  constructor(options = {}) {
    ...
    this.skillMapping = {
      ...
      architect: 'LMAS:agents:architect',
      'data-engineer': 'LMAS:agents:data-engineer',
      dev: 'LMAS:agents:dev',
      qa: 'LMAS:agents:qa',
      ...
      po: 'LMAS:agents:po',
      sm: 'LMAS:agents:sm',
      analyst: 'LMAS:agents:analyst',

      // Specialized agents
      'ux-design-expert': 'LMAS:agents:ux-design-expert',
      'ux-expert': 'LMAS:agents:ux-design-expert', // Alias
      devops: 'LMAS:agents:devops',
      'github-devops': 'LMAS:agents:devops', // Alias

      // Master agent
      'lmas-master': 'LMAS:agents:lmas-master',
    };
   ...
   * @returns {string} Full skill name (e.g., 'LMAS:agents:architect')
   */
  getSkillName(agentId) {
    return this.skillMapping[agentId] || `LMAS:agents:${agentId}`;
  }
  ...
  getAgentPersona(agentId) {
    return (
      this.agentPersonas[agentId] || { name: agentId, title: 'LMAS Agent' }
    );
  }
  ...
  isValidAgent(agentId) {
    return agentId in this.skillMapping || agentId.startsWith('LMAS:');
  }
}
