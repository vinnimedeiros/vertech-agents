...
class SubagentPromptBuilder {
  ...
  constructor(projectRoot) {
    ...
    this.lmasCoreRoot = path.join(projectRoot, '.lmas-core');

    // Paths to LMAS components
    this.paths = {
      agents: path.join(this.lmasCoreRoot, 'development', 'agents'),
      tasks: path.join(this.lmasCoreRoot, 'development', 'tasks'),
      checklists: path.join(this.lmasCoreRoot, 'product', 'checklists'),
      templates: path.join(this.lmasCoreRoot, 'product', 'templates'),
    };
  }
