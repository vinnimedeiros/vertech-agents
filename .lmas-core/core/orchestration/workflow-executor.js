...
class WorkflowExecutor {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.lmas-core/development/workflows/development-cycle.yaml',
    );
    this.statePath = path.join(projectRoot, '.lmas/workflow-state/');
    this.configPath = path.join(projectRoot, '.lmas-core/core-config.yaml');
