 ...
 */
const DEFAULT_CONFIG_PATH = '.lmas-core/core/quality-gates/quality-gate-config.yaml';
...
class QualityGateManager {
   ...
   */
  async getStatus() {
    const statusPath = this.config.status?.location || '.lmas/qa-status.json';
  ...
  async saveReport(storyId = 'unknown') {
    const reportDir = this.config.reports?.location || '.lmas/qa-reports';
