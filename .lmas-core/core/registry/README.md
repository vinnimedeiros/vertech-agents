# LMAS Service Registry

The Service Registry is the central catalog of all workers, tasks, templates, scripts, and workflows in the LMAS framework. It enables service discovery, search, and reuse across the system.
...
The builder scans:
- `.lmas-core/development/tasks/**/*.md` → task
- `.lmas-core/product/templates/**/*.md` → template
- `.lmas-core/infrastructure/scripts/**/*.js` → script
- `.lmas-core/product/checklists/**/*.md` → checklist
- `.lmas-core/development/workflows/**/*.yaml` → workflow
- `.lmas-core/core/data/**/*` → data
...
- **Discovery CLI** (Story 2.7-2.9): `lmas search`, `lmas info`, `lmas list`
...
*Generated by LMAS Framework v4.0.4*
