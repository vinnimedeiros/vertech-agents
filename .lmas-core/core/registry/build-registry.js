 ...
 *
 * Scans LMAS modules and builds the service registry JSON file.
...
const SCAN_SOURCES = [
  {
    pattern: '.lmas-core/development/tasks/**/*.md',
    category: 'task',
  ...
  {
    pattern: '.lmas-core/product/templates/**/*.md',
    category: 'template',
    taskFormat: 'TEMPLATE',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.lmas-core/infrastructure/scripts/**/*.js',
    category: 'script',
    taskFormat: 'SCRIPT',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.lmas-core/product/checklists/**/*.md',
    category: 'checklist',
    taskFormat: 'CHECKLIST',
    subcategoryExtractor: () => 'quality',
  },
  {
    pattern: '.lmas-core/development/workflows/**/*.yaml',
    category: 'workflow',
    taskFormat: 'WORKFLOW',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.lmas-core/core/data/**/*.md',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
    subcategoryExtractor: () => 'knowledge',
  },
  {
    pattern: '.lmas-core/core/data/**/*.yaml',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
...
async function main() {
  ...
  const outputPath = process.argv[3] || path.join(baseDir, '.lmas-core/core/registry/service-registry.json');
