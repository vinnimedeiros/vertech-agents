 ...
 *
 * Reads .lmas-core/constitution.md and generates .synapse/constitution
 * in KEY=VALUE format for the SYNAPSE Context Engine L0 layer.
 *
 * Usage: node .lmas-core/core/synapse/scripts/generate-constitution.js
 *
...
function generateConstitution(articles) {
  const lines = [
    ...
    '# Auto-generated from .lmas-core/constitution.md',
...
function main(options = {}) {
  ...
  const constitutionPath = options.constitutionPath || path.join(projectRoot, '.lmas-core', 'constitution.md');
