#!/usr/bin/env node
// =============================================================================
// LMAS Capability Detection Module
// =============================================================================
...
//
// Usage:
//   node .lmas-core/data/capability-detection.js
//
// Output:
//   .lmas/runtime-capabilities.json
// =============================================================================
...
const OUTPUT_PATH = path.join(PROJECT_ROOT, '.lmas', 'runtime-capabilities.json');
...
function loadToolRegistry() {
  const registryPath = path.join(PROJECT_ROOT, '.lmas-core', 'data', 'tool-registry.yaml');
  try {
