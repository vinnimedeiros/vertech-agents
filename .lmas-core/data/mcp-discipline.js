...
//
// Usage:
//   node .lmas-core/data/mcp-discipline.js --apply     # Disable non-essential
//   node .lmas-core/data/mcp-discipline.js --restore   # Re-enable all
//   node .lmas-core/data/mcp-discipline.js --status    # Show current state
//   node .lmas-core/data/mcp-discipline.js --enable <server>  # Re-enable specific
// =============================================================================
...
const BACKUP_PATH = path.join(PROJECT_ROOT, '.lmas', 'mcp-backup.json');
const CAPABILITIES_PATH = path.join(PROJECT_ROOT, '.lmas', 'runtime-capabilities.json');
