...
### Project Structure
- `.lmas-core/core/` — Core modules (synapse, session, code-intel, orchestration)
- `.lmas-core/development/` — Agents, tasks, templates, scripts
- `.lmas-core/infrastructure/` — CI/CD, git detection, project-status
...
- atomicWriteSync from `.lmas-core/core/synapse/utils/atomic-write` for safe file writes
