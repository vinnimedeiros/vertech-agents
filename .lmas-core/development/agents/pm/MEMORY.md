...
- State tracked in `.lmas/epic-{epicId}-state.yaml`
...
- Session state persistence in `.lmas/bob-session/`

### Key Locations
- PRD: `docs/prd/` (sharded)
- Epics: `docs/stories/epics/`
- Templates: `.lmas-core/development/templates/`
