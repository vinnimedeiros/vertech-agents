 ...
 *
 * Analyzes all 13 LMAS agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.lmas-core', 'agents', `${agentId}.md`);
...
function analyzeConfigNeeds(agentData) {
  ...
  if (agentData.agentId === 'lmas-master' ||
...
*Auto-generated by LMAS Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 LMAS agents...\n');
