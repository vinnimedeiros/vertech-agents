/**
 * Backlog Manager for LMAS Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by LMAS Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .lmas-core/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
