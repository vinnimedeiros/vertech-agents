...
async function updateAgent(agentFile) {
  ...
  try {
    ...
    const activationReplacement = '$1  - STEP 2.6: Load session context using .lmas-core/scripts/session-context-loader.js to detect previous agent and workflow state\n$2';
