...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.lmas-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.lmas-core/core-config.yaml)
...
*To manually rebuild the index, run: node .lmas-core/scripts/decision-log-indexer.js rebuild*
`;
