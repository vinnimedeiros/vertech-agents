/**
 * Dependency Analyzer for LMAS-FULLSTACK
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'lmas-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'lmas-core', 'agents'),
      tasks: path.join(this.rootPath, 'lmas-core', 'tasks'),
      workflows: path.join(this.rootPath, 'lmas-core', 'workflows')
    };
