...
const SCAN_CONFIG = [
  { category: 'tasks', basePath: '.lmas-core/development/tasks', glob: '**/*.md', type: 'task' },
  { category: 'templates', basePath: '.lmas-core/product/templates', glob: '**/*.{yaml,yml,md}', type: 'template' },
  { category: 'scripts', basePath: '.lmas-core/development/scripts', glob: '**/*.{js,mjs}', type: 'script' },
  { category: 'modules', basePath: '.lmas-core/core', glob: '**/*.{js,mjs}', type: 'module' },
  { category: 'agents', basePath: '.lmas-core/development/agents', glob: '**/*.{md,yaml,yml}', type: 'agent' },
  { category: 'checklists', basePath: '.lmas-core/development/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'data', basePath: '.lmas-core/data', glob: '**/*.{yaml,yml,md}', type: 'data' },
  { category: 'workflows', basePath: '.lmas-core/development/workflows', glob: '**/*.{yaml,yml}', type: 'workflow' },
  { category: 'utils', basePath: '.lmas-core/core/utils', glob: '**/*.js', type: 'util' },
  { category: 'tools', basePath: '.lmas-core/development/tools', glob: '**/*.{md,js,sh}', type: 'tool' },
  { category: 'infra-scripts', basePath: '.lmas-core/infrastructure/scripts', glob: '**/*.js', type: 'script' },
  { category: 'infra-tools', basePath: '.lmas-core/infrastructure/tools', glob: '**/*.{yaml,yml,md}', type: 'tool' },
  { category: 'product-checklists', basePath: '.lmas-core/product/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'product-data', basePath: '.lmas-core/product/data', glob: '**/*.{yaml,yml,md}', type: 'data' }
];
...
const KNOWN_AGENTS = [
  ...
  'analyst', 'data-engineer', 'ux-design-expert', 'lmas-master'
];
...
function populate(options = {}) {
  const verbose = options.verbose || process.argv.includes('--verbose') || process.env.LMAS_DEBUG === 'true';
