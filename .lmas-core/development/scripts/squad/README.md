...
Utilities for the squad-creator agent to manage squads in LMAS projects.
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".lmas-core/development/scripts/squad/*.js"
```
