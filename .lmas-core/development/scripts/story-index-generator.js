/**
 * Story Index Generator for LMAS Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by LMAS Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .lmas-core/scripts/story-index-generator.js docs/stories`*\n';
