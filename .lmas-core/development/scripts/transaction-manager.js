/**
 * Transaction Manager for LMAS-FULLSTACK
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'lmas-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'lmas-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'lmas-core', 'team-manifest.yaml');
