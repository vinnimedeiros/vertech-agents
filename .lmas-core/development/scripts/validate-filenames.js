 ...
 *
 * Usage:
 *   node .lmas-core/utils/validate-filenames.js
 *   node .lmas-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 LMAS Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .lmas-core/utils/validate-filenames.js --fix\n');
