 ...
 * New code should use: .lmas-core/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .lmas/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.lmas');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.lmas-core', 'development', 'agents');
