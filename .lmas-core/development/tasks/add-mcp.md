...
### 7. Update LMAS Documentation (REQUIRED)
...
**CRITICAL NOTE:** Tools added to Docker MCP Toolkit are NOT immediately available to LMAS agents. The docker-gateway caches tools at Claude Code startup. User MUST restart their Claude Code session for new tools to appear.
...
changelog:
  ...
  1.2.0:
    ...
    - Fixed: Tools not appearing in LMAS agents after MCP addition
  1.1.0:
