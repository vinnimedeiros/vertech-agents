...
const { getCodebaseOverview, getDependencyGraph } = require('.lmas-core/core/code-intel/helpers/planning-helper');
...
```javascript
// .lmas-core/core/orchestration/executor-assignment.js
const { assignExecutorFromContent } = require('.lmas-core/core/orchestration/executor-assignment');
