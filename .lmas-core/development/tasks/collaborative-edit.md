...
# Collaborative Edit - LMAS Developer Task
...
*collaborative-edit start --component lmas-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.lmas', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 LMAS Collaborative Editing'));
