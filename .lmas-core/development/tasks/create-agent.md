...
**Quality Standard:** LMAS Level (300+ lines, voice_dna, output_examples, command_loader, task files)
...
generate_agent:
  ...
  required_sections:
    # Level 1: Identity
    activation_notice: 'Standard LMAS header'
...
- Follow LMAS agent definition standards (6 levels)
