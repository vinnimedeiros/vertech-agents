...
# User selects from available templates in .lmas-core/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .lmas-core/product/templates or ask the user to provide another.
