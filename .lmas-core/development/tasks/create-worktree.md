...
pre-conditions:
  ...
  - [ ] WorktreeManager is available
    tipo: pre-condition
    blocker: true
    validação: Script exists at .lmas-core/infrastructure/scripts/worktree-manager.js
    error_message: "WorktreeManager not found. Ensure LMAS is properly installed."
...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .lmas/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .lmas-core/infrastructure/scripts/worktree-manager.js
...
- Directory: `.lmas/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .lmas/worktrees/{storyId}  - Navigate to worktree
...
- `.lmas/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .lmas/worktrees/{storyId}
...
- `.lmas-core/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.lmas-core/infrastructure/scripts/worktree-manager.js`
