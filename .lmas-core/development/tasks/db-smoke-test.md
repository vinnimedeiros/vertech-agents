...
- **Tool:** query-validator
  ...
  - **Source:** .lmas-core/utils/db-query-validator.js
...
- **Script:** db-query.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/scripts/db-query.js
...
3. `.lmas-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".lmas-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".lmas-core/product/templates/tmpl-smoke-test.sql"
else
