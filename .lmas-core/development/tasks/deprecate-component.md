...
# Deprecate Component - LMAS Developer Task
...
*deprecate-component util old-logger --replacement @lmas/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 LMAS Component Deprecation'));
