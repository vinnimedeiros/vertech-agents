...
# Improve Code Quality - LMAS Developer Task
...
*improve-code-quality lmas-core/scripts/legacy-utility.js --preview

# Auto-fix all safe improvements in directory
*improve-code-quality lmas-core/agents --auto-fix --recursive

# Apply specific patterns
*improve-code-quality lmas-core/utils --patterns formatting,modern-syntax,async-await

# Generate improvement report
*improve-code-quality . --recursive --report quality-report.json

# Use custom configuration
*improve-code-quality lmas-core --config .lmas/quality-config.json
```
...
class ImproveCodeQualityTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🎨 LMAS Code Quality Improvement'));
  ...
  async createBackup(filePath) {
    const backupDir = path.join(this.rootPath, '.lmas', 'backups', 'code-quality');
