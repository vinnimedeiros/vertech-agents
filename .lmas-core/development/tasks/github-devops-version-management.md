...
**Purpose**: Analyze changes, recommend version bumps, and manage semantic versioning for ANY repository using LMAS.
...
if (!context) {
  throw new Error('Unable to detect repository context. Run "lmas init" first.');
}
