...
Systematic triage of GitHub issues for the lmas-core repository. This task guides @devops through the process of reviewing, classifying, and labeling open issues.
...
```bash
node .lmas-core/development/scripts/issue-triage.js --list
node .lmas-core/development/scripts/issue-triage.js --apply {number} --type bug --priority P2 --area installer
```
...
```bash
node .lmas-core/development/scripts/issue-triage.js --report
```
