...
**Agent:** @lmas-master
**Story:** IDS-7 (lmas-master IDS Governor Integration)
...
```bash
node bin/lmas-ids.js ids:check "your intent" --type task
node bin/lmas-ids.js ids:impact create-doc
node bin/lmas-ids.js ids:stats --json
node bin/lmas-ids.js ids:register path/to/file.md
```
...
- `.lmas-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.lmas-core/core/ids/registry-loader.js` — RegistryLoader
- `.lmas-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.lmas-core/core/ids/registry-updater.js` — RegistryUpdater
- `.lmas-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
...
*IDS-7 | Created 2026-02-10 by @dev (Neo)*
