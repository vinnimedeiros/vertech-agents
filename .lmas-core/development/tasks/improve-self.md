...
if (process.env.LMAS_SAFE_MODE === 'true') {
  ...
  async execute(params) {
    ...
    try {
      ...
      const analysis = await analyzer.analyzeCapabilities({
        target_areas,
        currentImplementation: './lmas-core'
      });
