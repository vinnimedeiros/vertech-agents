...
Lists all LMAS-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

**Features:**

- Shows all active worktrees managed by LMAS
...
**Action:** Get all LMAS-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.lmas/worktrees/STORY-42",
...
No LMAS-managed worktrees found.
...
**Resolution:** Check LMAS installation.
...
- `.lmas-core/infrastructure/scripts/worktree-manager.js`
