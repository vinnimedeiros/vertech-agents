...
- **Tool:** ast-parser
  ...
  - **Source:** .lmas-core/utils/ast-parser.js
...
- **Script:** modify-file.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/scripts/modify-file.js
...
- Target agent must exist in `lmas-core/agents/`
...
- Load target agent from `lmas-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `lmas-core/agents/.backups/{agent-name}.md.{timestamp}`
