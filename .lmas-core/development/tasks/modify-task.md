...
- Target task must exist in `lmas-core/tasks/`
...
- Load target task from `lmas-core/tasks/{task-name}.md`
- Create timestamped backup: `lmas-core/tasks/.backups/{task-name}.md.{timestamp}`
