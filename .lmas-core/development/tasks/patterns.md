...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .lmas-core/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.lmas-core/workflow-intelligence/learning');
...
Storage file: .lmas-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .lmas-core/data/learned-patterns.yaml');
}
```
