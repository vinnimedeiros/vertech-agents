...
questions:
  - Story path (relative to docs/stories/):
    ...
    example: "epics/epic-pro-lmas-pro-architecture/story-pro-5-repo-bootstrap.md"
...
const changelogEntry = `| ${today} | ${version} | ${prInfo} merged ${commitInfo}. ${notes} Story closed. | Keymaker (@po) |`;
...
*close-story epics/epic-pro-lmas-pro-architecture/story-pro-5-repo-bootstrap.md
