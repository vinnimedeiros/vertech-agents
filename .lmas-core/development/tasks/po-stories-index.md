...
```javascript
const { generateStoryIndex } = require('.lmas-core/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 LMAS Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .lmas-core/scripts/story-index-generator.js docs/stories"
  }
}
```
