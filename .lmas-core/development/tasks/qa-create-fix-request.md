...
- **Script:** parse-qa-report.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/development/scripts/parse-qa-report.js (optional)
...
_Generated by Oracle (Test Architect) - LMAS QA System_
...
**Location:** `.lmas-core/development/tasks/qa-review-story.md`
