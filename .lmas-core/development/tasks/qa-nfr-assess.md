...
required:
  ...
  - story_path: `lmas-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `lmas-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `lmas-core/core-config.yaml` for the `technicalPreferences`
