...
2. Call `getReferenceImpact(files)` from `.lmas-core/core/code-intel/helpers/qa-helper.js`
...
### Reviewed By: Oracle (Test Architect)
...
- Create directory defined in `qa.qaLocation/gates` (see `.lmas-core/core-config.yaml`) if missing
...
reviewer: 'Oracle (Test Architect)'
