...
#### For Code PRs (packages/, .lmas-core/, bin/)
...
gh pr diff {pr_number} -- 'packages/' '.lmas-core/' 'bin/' | grep -E "(shell:\s*true|execSync\(|\.exec\(|eval\(|Function\()"
