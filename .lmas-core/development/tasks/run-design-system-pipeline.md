...
- **Tool:** build-component
  ...
  - **Source:** .lmas-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .lmas-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .lmas-core/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx lmas-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx lmas-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx lmas-core task run-design-system-pipeline --mode=yolo"
  }
}
```
