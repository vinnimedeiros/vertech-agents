...
- security-scan.js:
    ...
    language: JavaScript
    location: .lmas-core/scripts/security-scan.js
```
...
const utils_registry = config.utils?.registry || config['utils.registry'] || '.lmas-core/utils';
```
...
**Report Generator**: @qa (Oracle - Test Architect)
```
