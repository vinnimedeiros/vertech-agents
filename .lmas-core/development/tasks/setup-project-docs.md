...
- field: core_config
  type: file
  destination: .lmas-core/core-config.yaml
  persisted: true
...
pre-conditions:
  ...
  - [ ] Documentation Integrity module is available
    ...
    blocker: true
    validation: |
      Verify .lmas-core/infrastructure/scripts/documentation-integrity/index.js exists
...
post-conditions:
  ...
  - [ ] core-config.yaml created with valid deployment section
    ...
    blocker: true
    validation: |
      Verify .lmas-core/core-config.yaml exists and has deployment configuration
...
acceptance-criteria:
  ...
  - [ ] .gitignore properly configured for project
    ...
    blocker: true
    validation: |
      Assert .gitignore includes LMAS ignores and tech stack ignores
...
- **Tool:** documentation-integrity
  ...
  - **Source:** .lmas-core/infrastructure/scripts/documentation-integrity/index.js

- **Tool:** deployment-config-loader
  - **Purpose:** Load and validate deployment configuration
  - **Source:** .lmas-core/infrastructure/scripts/documentation-integrity/deployment-config-loader.js
...
- **Script:** mode-detector.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/infrastructure/scripts/documentation-integrity/mode-detector.js

- **Script:** doc-generator.js
  - **Purpose:** Generate project documentation from templates
  - **Language:** JavaScript
  - **Location:** .lmas-core/infrastructure/scripts/documentation-integrity/doc-generator.js

- **Script:** config-generator.js
  - **Purpose:** Generate core-config.yaml
  - **Language:** JavaScript
  - **Location:** .lmas-core/infrastructure/scripts/documentation-integrity/config-generator.js

- **Script:** gitignore-generator.js
  - **Purpose:** Generate or merge .gitignore
  - **Language:** JavaScript
  - **Location:** .lmas-core/infrastructure/scripts/documentation-integrity/gitignore-generator.js
...
```javascript
const { detectInstallationMode, collectMarkers } = require('./.lmas-core/infrastructure/scripts/documentation-integrity');
...
|------|-------------|---------|
| `framework-dev` | Contributing to lmas-core itself | Skip project setup, use existing config |
...
```javascript
const { buildDocContext, generateDocs } = require('./.lmas-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { buildConfigContext, generateConfig, DeploymentWorkflow, DeploymentPlatform } = require('./.lmas-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { generateGitignoreFile, hasLuan - MultiAgentes ScrumIntegration } = require('./.lmas-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { loadDeploymentConfig, validateDeploymentConfig } = require('./.lmas-core/infrastructure/scripts/documentation-integrity');
