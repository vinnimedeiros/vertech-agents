...
Migrates legacy squad formats to LMAS 2.1 standard.
...
| Missing `lmas.type` | Field not present | Add `lmas.type: squad` |
| Missing `lmas.minVersion` | Field not present | Add `lmas.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: lmas.type
  ❌ [ERROR] Missing required field: lmas.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: lmas.type = "squad"
  4. Add field: lmas.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: lmas.type = "squad" [success]
    ✅ Add field: lmas.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: lmas.type = "squad" [dry-run]
    🔍 Add field: lmas.minVersion = "2.1.0" [dry-run]
...
- **Schema:** .lmas-core/schemas/squad-schema.json
