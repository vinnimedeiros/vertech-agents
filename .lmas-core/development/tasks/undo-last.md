...
- **Tool:** backup-manager
  ...
  - **Source:** .lmas-core/utils/backup-manager.js
...
- **Script:** rollback-changes.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/scripts/rollback-changes.js
...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the lmas-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /lmas-core/agents/data-analyst.md
  - Updated: /lmas-core/team-manifest.yaml
  - Created: /lmas-core/tasks/analyze-data.md
```
