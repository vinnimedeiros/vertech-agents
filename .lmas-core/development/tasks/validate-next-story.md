...
- **Tool:** validation-engine
  ...
  - **Source:** .lmas-core/utils/validation-engine.js
...
- **Script:** run-validation.js
  ...
  - **Language:** JavaScript
  - **Location:** .lmas-core/scripts/run-validation.js
...
- Load `.lmas-core/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `lmas-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `lmas-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
**PRD Reference:** LMAS v2.0 "Projeto Bob" - Section 5 (Dynamic Executor Assignment)
...
- **If available:**
  - Call `validateNoDuplicates(storyDescription)` from `.lmas-core/core/code-intel/helpers/story-helper`
