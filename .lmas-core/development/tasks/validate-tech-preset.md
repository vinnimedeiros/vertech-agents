...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .lmas-core/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .lmas-core/data/tech-presets/{name}.md
...
- Preset: .lmas-core/data/tech-presets/{name}.md
```

## Related

- **Agent:** @architect (Architect)
- **Location:** .lmas-core/data/tech-presets/
