...
autoClaude:
  ...
  verification:
    type: script
    script: .lmas-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .lmas/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .lmas-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
