# LMAS Color Palette - Quick Reference
...
```javascript
// Import the LMAS color system
const { colors, status, headings } = require('./src/utils/lmas-colors');

// Use in your code
console.log(headings.h1('Welcome to LMAS!'));
...
### Welcome Screen
```javascript
console.log(headings.h1('🎉 Welcome to LMAS v4.2 Installer!'));
...
- **Complete Guide:** [LMAS-COLOR-PALETTE-V2.1.md](./LMAS-COLOR-PALETTE-V2.1.md)
- **Color Module:** `src/utils/lmas-colors.js`
