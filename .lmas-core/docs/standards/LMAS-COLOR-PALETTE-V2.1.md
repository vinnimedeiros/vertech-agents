# LMAS Color Palette v4.2

**Version:** 2.1.0  
**Created:** 2025-01-20  
**Status:** Active  
**Scope:** All LMAS CLI tools, installer, and visual outputs
...
The LMAS color palette is derived from the brand logo's vibrant gradient:
...
:root {
  /* Brand Colors */
  --lmas-primary: #8B5CF6;
  --lmas-secondary: #EC4899;
  --lmas-tertiary: #3B82F6;
  ...
  /* Gradient */
  --lmas-gradient: linear-gradient(135deg, #EC4899 0%, #8B5CF6 50%, #3B82F6 100%);
}
```
...
- Use `colors.brandPrimary` (purple bold) for LMAS branding
- Example: Welcome screens, major section headers

```javascript
console.log(colors.brandPrimary('🎉 LMAS v4.2 Installer'));
```
...
// Success
console.log(colors.success('\n✓ All done! Your LMAS project is ready.\n'));
```
  ...
  "lmas": {
    "color": {
      "primary": {
        "$type": "color",
        "$value": "#8B5CF6",
        "$description": "LMAS primary brand color (ClickUp-inspired purple)"
      },
      "secondary": {
        "$type": "color",
        "$value": "#EC4899",
        "$description": "LMAS secondary brand color (magenta accent)"
      },
      "success": {
        "$type": "color",
        "$value": "#10B981",
    ...
    "gradient": {
      "brand": {
        ...
        "$description": "LMAS brand gradient (logo-inspired)"
      }
    }
  }
}
...
|---------|------|---------|--------|
| 2.1.0 | 2025-01-20 | Initial LMAS Color Palette - Logo-inspired gradient + ClickUp purple | Uma (UX-Design Expert) |

---

## 🔗 Related Documents

- [LMAS-LIVRO-DE-OURO-V2.1](./LMAS-LIVRO-DE-OURO-V2.1-SUMMARY.md) - Complete LMAS standards
