# LMAS Task Format Specification V1.0
...
This document defines the UNIVERSAL format for LMAS Tasks, ensuring consistency, scalability, and reusability across workflows, executors, and teams.

---

## Task Format Overview

Every LMAS Task MUST follow this structure:
...
- callAgent:
    version: 1.0.0
    used_for: LMAS agent caller with retry logic
...
Use this checklist to validate any LMAS Task:
