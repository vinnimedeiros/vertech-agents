...
Multi-provider AI integration for LMAS. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.lmas-ai-config.yaml` in project root:
