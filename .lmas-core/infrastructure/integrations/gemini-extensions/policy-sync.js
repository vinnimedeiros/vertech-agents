...
class PolicySync {
  ...
  /**
   * Get LMAS permission policies
   */
  async getLMASPolicies() {
    const policiesPath = path.join(this.projectDir, '.lmas', 'policies.json');
  ...
  async exportToGemini() {
    const policies = await this.getLMASPolicies();
