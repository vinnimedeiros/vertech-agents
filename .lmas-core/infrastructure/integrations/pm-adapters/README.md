...
Project Management tool adapters for LMAS. Enables story synchronization with various PM tools.
...
PM tool is configured via `.lmas-pm-config.yaml` in the project root:
