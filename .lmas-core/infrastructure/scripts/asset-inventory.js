...
/**
 * LMAS Asset Inventory Generator
 * Story 2.1: Creates comprehensive inventory of all LMAS assets
 *
 * Usage:
...
const ASSET_PATHS = {
  ...
  templates: '.lmas-core/product/templates',
  checklists: '.lmas-core/product/checklists',
  scripts: '.lmas-core/infrastructure/scripts',
  schemas: '.lmas-core/schemas',
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  LMAS Asset Inventory');
...
Options:
  ...
  // Find project root (look for .lmas-core directory)
