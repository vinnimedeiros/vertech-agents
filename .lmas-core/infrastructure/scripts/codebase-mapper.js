 ...
 * - AC3: Output: `.lmas/codebase-map.json`
...
const CONFIG = {
  // AC3: Output path
  outputPath: '.lmas/codebase-map.json',
  // Schema version
  schemaVersion: '1.0',
  // Default max depth
  defaultMaxDepth: 5,
...
async function main() {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    console.log(`
Codebase Mapper - LMAS Memory Layer (Story 7.2)
...
Commands:
  ...
  save            Save to .lmas/codebase-map.json
