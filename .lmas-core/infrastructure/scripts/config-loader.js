 ...
 * 
 * LMAS Config Loader with Lazy Loading
 *
...
const agentRequirements = {
  ...
  'lmas-master': ['frameworkDocsLocation', 'projectDocsLocation', 'devLoadAlwaysFiles', 'lazyLoading', 'registry', 'expansionPacks', 'toolConfigurations'],
...
async function loadFullConfig() {
  const configPath = path.join('.lmas-core', 'core-config.yaml');
