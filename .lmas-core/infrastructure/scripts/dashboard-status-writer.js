 ...
 *
 * Writes the current LMAS agent status to .lmas/dashboard/status.json
...
const STATUS_DIR = '.lmas/dashboard';
 ...
 * Uses LMAS_PROJECT_ROOT env var or cwd
 */
function getProjectRoot() {
  return process.env.LMAS_PROJECT_ROOT || process.cwd();
}
