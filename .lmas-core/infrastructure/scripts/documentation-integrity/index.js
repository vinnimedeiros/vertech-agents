 ...
 *
 * Mode-aware project configuration system for LMAS.
...
module.exports = {
  ...
  isLmasCoreRepository: modeDetector.isLmasCoreRepository,
  ...
  hasLmasIntegration: gitignoreGenerator.hasLmasIntegration,
