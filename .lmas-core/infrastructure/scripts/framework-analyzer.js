...
class FrameworkAnalyzer {
  constructor(options = {}) {
    ...
    this.lmasCoreDir = path.join(this.rootPath, 'lmas-core');
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(this.lmasCoreDir, 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(this.lmasCoreDir, 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(this.lmasCoreDir, 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(this.lmasCoreDir, 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(this.lmasCoreDir, 'templates');
