 ...
 * - AC2: Generates `.lmas/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.lmas/gotchas.json',
...
*Generated by LMAS Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - LMAS Memory Layer (Story 7.4)
