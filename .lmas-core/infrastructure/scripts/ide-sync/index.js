...
function loadConfig(projectRoot) {
  const configPath = path.join(projectRoot, '.lmas-core', 'core-config.yaml');
...
function showHelp() {
  console.log(`
${colors.bright}IDE Sync${colors.reset} - Sync LMAS agents to IDE command files
