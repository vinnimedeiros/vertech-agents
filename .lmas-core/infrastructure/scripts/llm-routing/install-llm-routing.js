 ...
 *
 * @module llm-routing
 * @location .lmas-core/infrastructure/scripts/llm-routing/
 */
...
function getInstallationSummary(result) {
  ...
  if (result.success) {
    ...
    summary.push('');
    summary.push('Usage data saved to: ~/.lmas/usage-tracking/deepseek-usage.json');
    summary.push('');
  } else {
    summary.push('');
