 ...
 * @location .lmas-core/infrastructure/scripts/llm-routing/usage-tracker/
 */
...
const DATA_DIR = path.join(os.homedir(), '.lmas', 'usage-tracking');
...
║  Data File:    ~/.lmas/usage-tracking/deepseek-usage.json  ║
╠════════════════════════════════════════════════════════════╣
║  Endpoints:                                                ║
║    /health     - Health check                              ║
