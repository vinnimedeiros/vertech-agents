...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.lmas', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .lmas-core)
