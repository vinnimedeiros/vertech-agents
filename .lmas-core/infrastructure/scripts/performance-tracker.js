...
function generateReport() {
  ...
  let report = `# LMAS Performance Report
...
`;
  ...
  report += '\n---\n\n*Auto-generated by LMAS Performance Tracker (Story 6.1.2.6)*\n';
 ...
 */
async function savePerformanceData(filepath = '.lmas-core/performance-data.json') {
  const data = {
    ...performanceData,
 ...
 */
async function loadPerformanceData(filepath = '.lmas-core/performance-data.json') {
  try {
