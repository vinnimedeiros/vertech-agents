...
const CONFIG = {
  ...
  // Template path
  templatePath: '.lmas-core/product/templates/qa-report-tmpl.md',
...
*Generated by LMAS QA Report Generator v1.0*
`;
  }
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
QA Report Generator - LMAS QA Evolution (Story 6.2)
