 ...
 * @property {string} [worktreeDir='.lmas/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.lmas/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.lmas/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.lmas/logs/merges';
    this.gitPath = 'git';
  }
