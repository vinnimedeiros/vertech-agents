...
describe('ProjectStatusLoader', () => {
  ...
  beforeEach(async () => {
    ...
    testRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'lmas-test-'));
    loader = new ProjectStatusLoader(testRoot);
    cacheFile = path.join(testRoot, '.lmas', 'project-status.yaml');
  });
  ...
  describe('getWorktreesStatus', () => {
    ...
    it('should return worktree info with required fields', async () => {
      ...
      try {
        ...
        const worktreePath = path.join(testRoot, '.lmas', 'worktrees', 'STORY-TEST');
  ...
  describe('generateStatus with worktrees', () => {
    it('should include worktrees in generated status', async () => {
      ...
      try {
        ...
        // Create worktree
        const worktreePath = path.join(testRoot, '.lmas', 'worktrees', 'STORY-GEN');
