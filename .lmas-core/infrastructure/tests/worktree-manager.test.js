...
describe('WorktreeManager', () => {
  ...
  beforeEach(async () => {
    ...
    testRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'lmas-worktree-test-'));
  ...
  describe('constructor', () => {
    it('should use default options when none provided', () => {
      ...
      expect(defaultManager.worktreeDir).toBe('.lmas/worktrees');
  ...
  describe('getWorktreePath', () => {
    it('should return correct path for story', () => {
      ...
      expect(wtPath).toBe(path.join(testRoot, '.lmas/worktrees', 'STORY-42'));
    });
  });
