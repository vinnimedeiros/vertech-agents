#!/usr/bin/env python3
"""
Send event to LMAS Monitor server.
...
SERVER_URL = os.environ.get("LMAS_MONITOR_URL", "http://localhost:4001")
TIMEOUT_MS = int(os.environ.get("LMAS_MONITOR_TIMEOUT_MS", "500"))
