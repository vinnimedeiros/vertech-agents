...
This template defines the canonical activation-instructions format for LMAS agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .lmas-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .lmas-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .lmas-core/scripts/session-context-loader.js
...
- ✅ Minimal greeting (e.g., "🎯 Keymaker ready")
...
- **GreetingBuilder**: `.lmas-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.lmas-core/core/session/context-detector.js`
- **Git Config Detector**: `.lmas-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.lmas-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.lmas-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.lmas-core/data/workflow-patterns.yaml`
...
*Template maintained by LMAS Framework Team*
