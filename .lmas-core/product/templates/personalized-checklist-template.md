...
2. All tests pass
3. Execute `.lmas-core/product/checklists/story-dod-checklist.md`
...
node .lmas-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .lmas-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.lmas-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.lmas-core/agents/{agent-id}.md`
...
**Examples:**
- **Neo (Builder):** "Checklists são blueprints. Siga-os à risca e construa com confiança. 🔨"
- **Oracle (Guardian):** "Cada item é uma proteção. Não pule nenhum. Sua segurança depende disso. 🛡️"
- **Keymaker (Balancer):** "Use bom senso. Checklist é guia, não prisão. Adapte ao contexto. ⚖️"
