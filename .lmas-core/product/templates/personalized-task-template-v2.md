...
```yaml
task: {taskIdentifier()}
responsável: {AgentName}          # Agent executing this task (e.g., Neo, Oracle, Keymaker)
...
- **Builder (Neo):** "✅ Implementei com sucesso. {detail}."
- **Guardian (Oracle):** "✅ Validado rigorosamente. {detail}."
- **Balancer (Keymaker):** "✅ Equilibrei todas as dependências. {detail}."
...
```yaml
**Scripts:**
- .lmas-core/scripts/dev-specific/test-runner.js:
    description: Runs tests with coverage reporting specific to dev agent
    language: javascript
    version: 1.2.0

- .lmas-core/scripts/qa-specific/regression-validator.js:
...
- fallback: |
    ...
    2. Use generic template from .lmas-core/product/templates/
...
- error_message: |
    ...
    **Examples:**
    - Neo: "⚠️ Não consigo implementar sem a tool 'mcp-supabase'. Preciso dela pra continuar."
    - Oracle: "⚠️ Ferramenta 'coderabbit' ausente. Não posso validar sem ela. Bloqueando task."
```
...
- fallback: |
    ...
    1. Check alternative data sources (.lmas-core/data/)
...
- error_message: |
    ...
    **Examples:**
    - Neo: "⚠️ Build falhou. Tentando novamente com cleanup antes..."
    - Oracle: "⚠️ Post-condition falhou: output schema inválido. Bloqueando execução."
```
...
**Examples:**
- Neo: "✅ Implementei com sucesso. 3 componentes criados."
- Oracle: "✅ Validado rigorosamente. 47 edge cases testados."
- Keymaker: "✅ Equilibrei as dependências. Tudo alinhado."
...
- **CRITICAL:** Follow LMAS Task Format Specification V1.0 exactly
...
- See `.lmas-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md` for complete spec
- See `.lmas-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for personality guidelines

---

**Template Version:** 2.0
**Last Updated:** 2025-01-14
**Applies to:** All tasks with LMAS Task Format V1.0 + Personalized Agents (Story 6.1.2+)
