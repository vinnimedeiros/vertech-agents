...
- **Builder (Neo):** "✅ Tá pronto! Implementei todas as funcionalidades."
- **Guardian (Oracle):** "✅ Validado com rigor. 47 edge cases testados."
- **Balancer (Keymaker):** "✅ Story completa. Equilibrei performance vs. legibilidade."
...
**Example:**
```markdown
💻 Neo (Builder): Preciso saber qual approach você prefere.
...
**Tasks:**
- `.lmas-core/tasks/{dependency1}.md`
- `.lmas-core/tasks/{dependency2}.md`

**Templates:**
- `.lmas-core/product/templates/{template1}.yaml`

**Checklists:**
- `.lmas-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.lmas-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.lmas-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
