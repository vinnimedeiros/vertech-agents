...
/**
 * LMAS Unified Statusline v3 for Claude Code
 *
 * Displays: Session | Model | Context Bar | Time | Agent | Squad | Project:Branch | Git | Messages | Alert
 *
 * Installed automatically by `npx lmas-core install` when no existing statusline is detected.
 * Source: .lmas-core/product/templates/statusline/
 */
