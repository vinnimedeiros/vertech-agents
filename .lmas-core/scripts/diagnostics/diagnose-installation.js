#!/usr/bin/env node
/**
 * LMAS-Core Installation Diagnostic Tool
 *
 * Run this script to diagnose installation issues:
 *   node diagnose-installation.js
 *
 * Or directly from URL:
 *   npx https://raw.githubusercontent.com/LMAS/lmas-core/main/tools/diagnose-installation.js
 */
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════════╗');
console.log('║          LMAS-Core Installation Diagnostic Tool                  ║');
console.log('╚══════════════════════════════════════════════════════════════════╝');
console.log('');
...
const pkgInfo = exec('npm view lmas-core version 2>&1');
if (pkgInfo && !pkgInfo.includes('E404') && !pkgInfo.includes('error')) {
  console.log(`  ✓ lmas-core v${pkgInfo} is available on npm`);
} else {
  console.log('  ⚠️  Cannot verify lmas-core package availability');
...
console.log('  Testing: npx lmas-core@latest --version');
const npxTest = exec('npx lmas-core@latest --version 2>&1');
...
if (hasErrors) {
  ...
  console.log('');
  console.log('You can install LMAS-Core with:');
  console.log('  npx lmas-core@latest');
  console.log('');
}
...
const summaryFile = path.join(os.tmpdir(), 'lmas-diagnostic-result.json');
