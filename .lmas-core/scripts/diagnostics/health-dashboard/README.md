# LMAS Health Dashboard

Visual dashboard for the LMAS Health Check System. Displays real-time health status, domain scores, issues, and self-healing history.
...
- **Production**: Reads from `.lmas/reports/health-check-latest.json`
...
- [Health Check Core Module](../../.lmas-core/core/health-check/)
- [JSON Reporter](../../.lmas-core/core/health-check/reporters/json.js)

---

_Part of LMAS-FULLSTACK - Story HCS-2 Phase 4_
