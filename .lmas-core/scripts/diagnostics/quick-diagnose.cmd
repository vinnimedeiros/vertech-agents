...
echo.
echo ========================================
echo    LMAS-Core Quick Diagnostic (CMD)
echo ========================================
echo.
...
echo.
echo Checking lmas-core availability on npm...
npm view lmas-core version 2>nul
if %errorlevel% neq 0 (
    echo   ERROR: Cannot access npm registry!
    echo   Check your internet/firewall settings
) else (
    echo   lmas-core: Available
)

echo.
echo ========================================
echo    Testing npx lmas-core@latest
echo ========================================
echo.
echo Running: npx lmas-core@latest --version
echo (This may take a moment on first run...)
echo.
npx lmas-core@latest --version
if %errorlevel% neq 0 (
    echo.
    echo   ERROR: npx lmas-core failed!
    echo.
    echo Common fixes:
