# LMAS-Core Quick Diagnostic - Run this in PowerShell
# Usage: Copy and paste this entire script into PowerShell on the target machine

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "   LMAS-Core Quick Diagnostic" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$registryTest = & npm view lmas-core version 2>$null
if ($registryTest) {
    Write-Host "  lmas-core v$registryTest available" -ForegroundColor Green
} else {
...
# Test npx lmas-core
Write-Host ""
Write-Host "Testing: npx lmas-core@latest --version" -ForegroundColor Yellow
Write-Host "(This may take a moment...)" -ForegroundColor Gray
try {
    $result = & npx lmas-core@latest --version 2>&1
...
Write-Host "  npx lmas-core@latest" -ForegroundColor White
Write-Host ""
