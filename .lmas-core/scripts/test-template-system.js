...
class TestTemplateSystem {
  constructor(options = {}) {
    ...
    this.templatesDir = path.join(this.rootPath, 'lmas-core', 'templates', 'tests');
  ...
  async generateTestContent(component, testFile, config) {
    ...
    const templateData = {
      ...
      metadata: {
        ...
        generator: 'LMAS Test Template System',
        version: '1.0.0',
      },
    };
    ...
    return {
      agent: {
        ...
        setup: {
          ...
          beforeEach: [
            "agentPath = path.join(__dirname, '../../../lmas-core/agents/{{component.name}}.md');",
      ...
      task: {
        ...
        setup: {
          ...
          beforeEach: [
            "taskPath = path.join(__dirname, '../../../lmas-core/tasks/{{component.name}}.md');",
      ...
      workflow: {
        ...
        setup: {
          ...
          beforeEach: [
            "workflowPath = path.join(__dirname, '../../../lmas-core/workflows/{{component.name}}.yaml');",
      ...
      util: {
        ...
        setup: {
          ...
          beforeEach: [
            "UtilClass = require('../../../lmas-core/scripts/{{component.name}}');",
...
afterAll(async () => {
  ...
  renderMetadata(metadata, data) {
    return `
// Generated by LMAS Test Template System
