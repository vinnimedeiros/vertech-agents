...
### Added
- 8 specialist agents: claude-mastery-chief (Morpheus), hooks-architect (Latch), mcp-integrator (Piper), swarm-orchestrator (Nexus), config-engineer (Sigil), skill-craftsman (Anvil), project-integrator (Conduit), roadmap-sentinel (Vigil)
...
- LMAS-core integration bridge (agents, tasks, hooks, config mapping)

### Architecture
- Entry agent: claude-mastery-chief (Morpheus) with 7-domain routing matrix
- Cross-cutting concern: all agents understand LMAS-core architecture
