...
|------|-------|---------|----------|-------|-------|
| 0 | claude-mastery-chief | Morpheus | Original | 554 | Triage, routing, cross-cutting knowledge |
...
| 2 | project-integrator | Conduit | Daniel Miessler (PAI) | 959 | Project integration, CI/CD, LMAS bridge |
...
```
Or use the LMAS activation:
```
/LMAS:agents:claude-mastery-chief
```

### Direct Specialist Access
```
/LMAS:agents:hooks-architect        # Hook automation
/LMAS:agents:mcp-integrator         # MCP servers
/LMAS:agents:swarm-orchestrator     # Multi-agent orchestration
/LMAS:agents:config-engineer        # Settings & permissions
/LMAS:agents:skill-craftsman        # Skills & plugins
/LMAS:agents:project-integrator     # Project integration
/LMAS:agents:roadmap-sentinel       # Updates & roadmap
```
...
| LMAS Bridge | Morpheus + Conduit | `*lmas-bridge`, `*lmas-guide` |
...
This squad understands both Claude Code native capabilities AND the LMAS-core framework:

| LMAS Concept | Claude Code Equivalent | Bridge Agent |
|-------------|----------------------|-------------|
| Agents (@dev, @qa...) | Subagents (.claude/agents/) | Nexus |
| Tasks (.lmas-core/tasks/) | Skills (.claude/skills/) | Anvil |
| Workflows | Multi-step sessions | Nexus + Morpheus |
...
├── README.md                      # This file
├── agents/
│   ├── claude-mastery-chief.md    # Tier 0: Orchestrator (Morpheus)
