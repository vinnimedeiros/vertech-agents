<!-- DEPRECATED: Merovingian (@traffic-manager) é agora o chief do traffic-masters. Este arquivo é mantido como referência. Use /LMAS:agents:traffic-manager para ativar o chief. -->
